  ...
  function renderCard(item, container) {
    ...
    container.innerHTML = `
      <div style="background:#fff;border-radius:10px;padding:11px 12px 0;position:relative;
        ...
        ${imgSrc ? `
        <div style="width:100%;margin:5px 0;border-radius:6px;overflow:hidden;background:#f5f5f5;">
  ...
  function buildPrintHTML(data){
    ...
    function card(it){
      ...
      var imgBlock=it.imagem
        ? '<div style="width:100%;margin:5px 0;border-radius:5px;overflow:hidden;background:#f5f5f5;"><img src="'+it.imagem+'" style="width:100%;height:auto;display:block;"></div>'
        : '';
    ...
    return '<!DOCTYPE html><html><head><meta charset="utf-8"><title>Pauta Iconográfica</title>'
      ...
      + '<style>@page{size:A4;margin:0}@media print{body{-webkit-print-color-adjust:exact;print-color-adjust:exact}}'
      + 'body{margin:0;padding:0;background:'+cream+';font-family:Arial,sans-serif;color:'+ink+'}'
      + '.page{width:794px;min-height:1123px;margin:0 auto;background:'+cream+';padding-bottom:30px;position:relative}'
      + '.col{display:flex;flex-direction:column;gap:10px}'
      + '</style></head><body>'
      + '<div class="page">'
      + '<div style="padding:16px 22px 6px;border-bottom:2px solid rgba(30,53,80,.15);">'
        + '<div style="text-align:center;font-family:'Barlow Condensed',Arial,sans-serif;font-size:22px;font-weight:800;color:'+ink+';">'
